...
but do not stop the import.`,
  ...
  sculptok-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  sculptok-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | sculptok-pp-cli import <resource> --input -`,
