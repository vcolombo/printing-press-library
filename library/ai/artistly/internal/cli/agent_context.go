...
func buildAgentDiscoveryContext() *agentContextDiscovery {
	return &agentContextDiscovery{
		...
		TargetURL:     "https://app.artistly.ai/ai/ai-design-agents",
		EntryCount:    91,
		APIEntryCount: 4,
		...
		CandidateCommands: []string{
			"create_auth — Derived from observed POST /broadcasting/auth traffic.",
			"list_ai_design_agents — Derived from observed GET /ai/ai-design-agents traffic.",
			"list_fetch_personal_designs — Derived from observed GET /fetch-personal-designs traffic.",
