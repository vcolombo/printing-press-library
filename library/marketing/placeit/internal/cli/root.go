...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "placeit-pp-cli",
		Short: `Placeit CLI — Every one of Placeit's 164k mockup, logo, video, and design templates — searchable, sortable by real popularity, and ca…`,
		Long: `Placeit CLI — Every one of Placeit's 164k mockup, logo, video, and design templates — searchable, sortable by real popularity, and ca…
...
Health check: run 'placeit-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("placeit-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'placeit-pp-cli profile list')")
	...
	rootCmd.AddCommand(newCatalogSyncCmd(flags))
	rootCmd.AddCommand(newSearchCmd(flags))
	rootCmd.AddCommand(newTemplateCmd(flags))
	rootCmd.AddCommand(newFacetsCmd(flags))
	rootCmd.AddCommand(newIndustriesCmd(flags))
	rootCmd.AddCommand(newOpenCmd(flags))
	rootCmd.AddCommand(newWorkflowCmd(flags))
	rootCmd.AddCommand(newNovelGapsCmd(flags))
	rootCmd.AddCommand(newNovelIndustryMapCmd(flags))
	rootCmd.AddCommand(newNovelKitCmd(flags))
	rootCmd.AddCommand(newNovelPodCmd(flags))
	rootCmd.AddCommand(newNovelRankCmd(flags))
	rootCmd.AddCommand(newNovelTopCmd(flags))
