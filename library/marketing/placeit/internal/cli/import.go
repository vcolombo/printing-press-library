...
but do not stop the import.`,
  ...
  placeit-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  placeit-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | placeit-pp-cli import <resource> --input -`,
