...
but do not stop the import.`,
  ...
  listingview-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  listingview-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | listingview-pp-cli import <resource> --input -`,
