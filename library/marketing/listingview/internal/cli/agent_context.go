...
func buildAgentDiscoveryContext() *agentContextDiscovery {
	return &agentContextDiscovery{
		...
		TargetURL:     "https://app.listingview.io",
		EntryCount:    20,
		APIEntryCount: 20,
		...
		CandidateCommands: []string{
			"create_add_remove_favourite — Derived from observed POST /api/proxy/api/integration/etsy/add-remove-favourite traffic.",
			"create_analytics — Derived from observed POST /api/proxy/api/integration/etsy/listing-explorer/analytics traffic.",
			"create_getFilteredKeywords — Derived from observed POST /api/proxy/api/integration/etsy/getFilteredKeywords traffic.",
			"create_getFilteredListings — Derived from observed POST /api/proxy/api/integration/etsy/getFilteredListings traffic.",
			"create_getFilteredTags — Derived from observed POST /api/proxy/api/integration/etsy/getFilteredTags traffic.",
			"create_get_filtered_shops — Derived from observed POST /api/proxy/api/integration/etsy/get-filtered-shops traffic.",
			"create_listings — Derived from observed POST /api/proxy/api/integration/etsy/shop-analyzer/listings traffic.",
			"create_progress — Derived from observed POST /api/proxy/api/integration/etsy/shop-analyzer/progress traffic.",
		},
	}
}
