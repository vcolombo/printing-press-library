...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "listingview-pp-cli",
		Short: `Listingview CLI — Every ListingView research tool in your terminal, plus a local database that adds drift tracking, niche scoring, and of…`,
		Long: `Listingview CLI — Every ListingView research tool in your terminal, plus a local database that adds drift tracking, niche scoring, and of…
...
Health check: run 'listingview-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("listingview-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'listingview-pp-cli profile list')")
	...
	rootCmd.AddCommand(newNovelOpportunitiesCmd(flags))
