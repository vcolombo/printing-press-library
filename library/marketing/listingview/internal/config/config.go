...
type Config struct {
	...
	ListingviewCookies string          `toml:"cookies"`
}

func Load(configPath string) (*Config, error) {
	cfg := &Config{
		BaseURL: "https://app.listingview.io",
	}
	...
	if v := os.Getenv("LISTINGVIEW_COOKIES"); v != "" {
		cfg.ListingviewCookies = v
		cfg.markEnvOverride("ListingviewCookies")
		cfg.AuthSource = "env:LISTINGVIEW_COOKIES"
		cfg.CredentialSource = "env:LISTINGVIEW_COOKIES"
	}
	...
	if v := os.Getenv("LISTINGVIEW_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	return cfg, nil
}
...
func resolveConfigPath(configPath string) (string, bool, error) {
	...
	if path := os.Getenv("LISTINGVIEW_CONFIG"); path != "" {
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "listingview-pp-cli", "config.toml"), nil
}
...
func (c *Config) AuthHeader() string {
	...
	if c.ListingviewCookies != "" {
		if c.AuthSource == "" {
			c.AuthSource = "env:LISTINGVIEW_COOKIES"
		}
		return ensureAuthScheme("Bearer", c.ListingviewCookies)
	}
	if c.AccessToken != "" {
		if c.AuthSource == "" {
...
func (c *Config) credentials() *cliutil.Credentials {
	return &cliutil.Credentials{
		...
		ListingviewCookies: c.ListingviewCookies,
	}
}
...
func (c *Config) applyCredentials(creds *cliutil.Credentials) {
	...
	c.ListingviewCookies = creds.ListingviewCookies
}
...
func (c *Config) ClearTokens() error {
	...
	c.updateFileConfigField("ClientSecret")
	c.ListingviewCookies = ""
	delete(c.envOverrides, "ListingviewCookies")
	c.updateFileConfigField("ListingviewCookies")
	if c.AgentcookieManagedByExternalStore() {
		c.markAgentcookieManaged()
...
func (c *Config) configForSave() Config {
	out := *c
	if c.fileConfig != nil {
		if c.envOverrides["ListingviewCookies"] {
			out.ListingviewCookies = c.fileConfig.ListingviewCookies
		}
	}
...
func (c *Config) updateFileConfigField(field string) {
	...
	case "ListingviewCookies":
		c.fileConfig.ListingviewCookies = c.ListingviewCookies
	}
}
