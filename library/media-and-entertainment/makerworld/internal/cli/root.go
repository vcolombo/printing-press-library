...
Health check: run 'makerworld-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("makerworld-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'makerworld-pp-cli profile list')")
	...
	rootCmd.AddCommand(newNovelDiscoverCmd(flags))
	...
	rootCmd.AddCommand(newDesignersPromotedCmd(flags))
