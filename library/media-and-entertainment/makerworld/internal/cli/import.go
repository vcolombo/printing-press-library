...
but do not stop the import.`,
  ...
  makerworld-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  makerworld-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | makerworld-pp-cli import <resource> --input -`,
