...
func newDoctorCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: `  creativefabrica-pp-cli doctor
  creativefabrica-pp-cli doctor --json
  creativefabrica-pp-cli doctor --fail-on warn`,
			...
			if cfg != nil && cfg.BaseURL != "" {
				...
				if clientErr != nil {
					...
					if authHeader == "" {
						...
						if suggestion != "" {
							report["credentials"] = fmt.Sprintf("present, not verified. Run `%s %s` to confirm the token works end-to-end.", "creativefabrica-pp-cli", suggestion)
						} else {
