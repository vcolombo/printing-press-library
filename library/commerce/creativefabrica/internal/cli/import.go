...
but do not stop the import.`,
  ...
  creativefabrica-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  creativefabrica-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | creativefabrica-pp-cli import <resource> --input -`,
