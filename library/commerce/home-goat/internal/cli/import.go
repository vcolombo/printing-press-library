...
but do not stop the import.`,
  ...
  home-goat-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  home-goat-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | home-goat-pp-cli import <resource> --input -`,
