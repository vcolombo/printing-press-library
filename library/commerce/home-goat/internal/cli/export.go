...
large datasets as it has no memory pressure.`,
  ...
  home-goat-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  home-goat-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  home-goat-pp-cli export <resource> --format jsonl | jq '.id'`,
