...
func newWatchAddCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: "  home-goat-pp-cli watch add https://www.westelm.com/products/mid-century-sofa --threshold 15",
...
func newWatchRemoveCmd(flags *rootFlags) *cobra.Command {
	return &cobra.Command{
		...
		Example: "  home-goat-pp-cli watch remove https://www.westelm.com/products/mid-century-sofa",
		RunE: func(cmd *cobra.Command, args []string) error {
			if len(args) == 0 {
				return cmd.Help()
			}
...
func newWatchHistoryCmd(flags *rootFlags) *cobra.Command {
	return &cobra.Command{
		...
		Example: "  home-goat-pp-cli watch history https://www.westelm.com/products/mid-century-sofa",
		RunE: func(cmd *cobra.Command, args []string) error {
			if len(args) == 0 {
				return cmd.Help()
			}
