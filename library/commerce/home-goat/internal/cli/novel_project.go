...
func newProjectCreateCmd(flags *rootFlags) *cobra.Command {
	return &cobra.Command{
		...
		Example: "  home-goat-pp-cli project create \"Kitchen Reno\"",
...
func newProjectShowCmd(flags *rootFlags) *cobra.Command {
	return &cobra.Command{
		...
		Example: "  home-goat-pp-cli project show \"Kitchen Reno\"",
		RunE: func(cmd *cobra.Command, args []string) error {
			if len(args) == 0 {
				return cmd.Help()
			}
...
func newProjectAddCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: "  home-goat-pp-cli project add \"Kitchen Reno\" https://www.westelm.com/products/faucet --quantity 2 --price 299.99",
		RunE: func(cmd *cobra.Command, args []string) error {
			if len(args) < 2 {
				return cmd.Help()
			}
			...
			if err == sql.ErrNoRows {
				return notFoundErr(fmt.Errorf("project %q not found; create it first with: home-goat-pp-cli project create %q", name, name))
			}
			if err != nil {
				return fmt.Errorf("looking up project: %w", err)
			}
...
func newProjectRemoveCmd(flags *rootFlags) *cobra.Command {
	return &cobra.Command{
		...
		Example: "  home-goat-pp-cli project remove \"Kitchen Reno\" https://www.westelm.com/products/faucet",
		RunE: func(cmd *cobra.Command, args []string) error {
			if len(args) < 2 {
				return cmd.Help()
			}
...
func newProjectBudgetCmd(flags *rootFlags) *cobra.Command {
	return &cobra.Command{
		...
		Example: "  home-goat-pp-cli project budget \"Kitchen Reno\"",
		RunE: func(cmd *cobra.Command, args []string) error {
			if len(args) == 0 {
				return cmd.Help()
			}
...
func newProjectDeleteCmd(flags *rootFlags) *cobra.Command {
	return &cobra.Command{
		...
		Example: "  home-goat-pp-cli project delete \"Kitchen Reno\"",
		RunE: func(cmd *cobra.Command, args []string) error {
			if len(args) == 0 {
				return cmd.Help()
			}
