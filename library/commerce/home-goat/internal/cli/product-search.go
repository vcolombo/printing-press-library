...
Use subcommands (westelm-search, ferguson-search, etc.) to target a single source.`,
		Example: `  home-goat-pp-cli product-search "floating vanity"
  home-goat-pp-cli product-search "pendant light" --room bathroom
  home-goat-pp-cli product-search "sofa" --category furniture --sort price-asc
  home-goat-pp-cli product-search westelm-search "table lamp"`,
