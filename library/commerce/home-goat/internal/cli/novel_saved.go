...
func newSaveCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: "  home-goat-pp-cli save https://www.article.com/product/sven-sofa --title \"Sven Sofa\" --price 1899",
...
func newSavedRemoveCmd(flags *rootFlags) *cobra.Command {
	return &cobra.Command{
		...
		Example: "  home-goat-pp-cli saved remove https://www.article.com/product/sven-sofa",
		RunE: func(cmd *cobra.Command, args []string) error {
			if len(args) == 0 {
				return cmd.Help()
			}
